...
class Coin(arcade.Sprite):
    def __init__(self, x, y):
        super().__init__(f"../mario_comb/images/score.png")
        self.center_x = x
        self.center_y = y
        self.scale = 0.04
...
class MarioGame(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.score_number = 0
        self.score_texture = arcade.load_texture(f"../mario_comb/images/score.png")
        self.heart = arcade.load_texture(f"../mario_comb/images/heart.png")
